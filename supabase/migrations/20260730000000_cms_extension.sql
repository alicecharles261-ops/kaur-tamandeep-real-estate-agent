...
-- 2. Add new CMS columns to properties
...
-- 3. Grant write permissions to authenticated role
GRANT INSERT, UPDATE, DELETE ON public.properties TO authenticated;
GRANT INSERT, UPDATE, DELETE ON public.reviews    TO authenticated;

-- 4. RLS write policies for admin (authenticated users)
...
-- 7. Storage RLS: property-documents
